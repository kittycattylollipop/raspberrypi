...
class mywindow(QMainWindow,Ui_Client):
    def __init__(self):
        ...
        self.VSlider_Servo2.setMaximum(140)
    ...
    def on_btn_ForWard(self):
        ForWard=self.intervalChar+str(-800)+self.intervalChar+str(-800)+self.intervalChar+str(-800)+self.intervalChar+str(-800)+self.endChar
    ...
    def on_btn_BackWard(self):
        BackWard=self.intervalChar+str(800)+self.intervalChar+str(800)+self.intervalChar+str(800)+self.intervalChar+str(800)+self.endChar
