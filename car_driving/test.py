...
def test_Led():
    try:
        led.ledIndex(0x01,181,255,227)      
        led.ledIndex(0x02,255,242,156)    
        led.ledIndex(0x04,129,170,181)    
        led.ledIndex(0x08,80,40,117)      
        led.ledIndex(0x10,240,192,229)    
        led.ledIndex(0x20,117,151,235)      
        led.ledIndex(0x40,219,255,220)    
        led.ledIndex(0x80,255,182,150)  
        print "The LED has been lit, the color is red orange yellow green cyan-blue blue white"
        time.sleep(1)               #wait 3s
        led.colorWipe(led.strip, Color(255,0,0),500)  #turn off the light
        time.sleep(5)
